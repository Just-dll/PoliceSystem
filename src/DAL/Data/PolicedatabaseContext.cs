...
public partial class PolicedatabaseContext : DbContext
{
    ...
    public virtual DbSet<CaseFileConnectionType> CaseFileConnectionTypes { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CaseFileConnection>(entity =>
        {
            ...
            entity.HasOne(cfc => cfc.CaseFileConnectionType)
                .WithMany(cfct => cfct.CaseFileConnections)
                .IsRequired();
        });
